...
def check(headline, body):
    ...
    if 'unreliable' in predicted:
        print(news['Unreliable'][0])
        return {'probability': news['Unreliable'][0], 'predicted_class': 'Unreliable'}
    return {'probability': news['Reliable'][0], 'predicted_class': 'Reliable'}
